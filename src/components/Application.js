          ...
          <Modal.Body>
            <Form>
              ...
              <Form.Group
                ...
                controlId="exampleForm.ControlInput1"
              >
                <Form.Label className="">LOAN AMOUNT NEEDED</Form.Label>
              ...
              <Form.Group
                ...
                controlId="exampleForm.ControlInput1"
              >
                <Form.Label className="mt-3">RELIGION</Form.Label>
              ...
              <Form.Group
                ...
                controlId="exampleForm.ControlInput1"
              >
                <Form.Label>EXPERINCE IN CURRENT JOB</Form.Label>
              ...
              <Form.Group
                ...
                controlId="exampleForm.ControlInput1"
              >
                <Form.Label>TOTAL/ OVERALL JOB EXPERIENCE</Form.Label>
                <Form.Control type="number" />
              </Form.Group>
              <Form.Group
                className="mb-3"
